...
%%% pseudo-esatico de un muro de retención trapezoidal rectangular por el metodo de RICHARD-ELMS.
...
function [FSD,FSVR,FSVA,FSDs,FSVRs,FSVAs,dEae,Ww2,Ww3]= MtripseudoRyE(Base1,Base2,Ha,D,B,alpha,phib,concreto,espesor,phi,PesoE,Cohesion,n,k,espe,pe,ph,R,TS,R1,R2,kh,kv,So)
     kh=round(kh,3);
     if ismcc || isdeployed
