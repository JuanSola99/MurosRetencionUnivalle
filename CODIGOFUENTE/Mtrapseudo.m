...
%%% pseudo-esatico de un muro de retención trapezoidal isósceles por el metodo de MONOBE-OKABE.
...
function [FSD,FSVR,FSVA,FSDs,FSVRs,FSVAs,dEae]=Mtrapseudo(Base,Co,Ha,D,B,alpha,phib,concreto,espesor,phi,PesoE,Cohesion,n,k,espe,pe,ph,R,TS,R1,R2,kh,kv,So)
...
%                                 append(s3,plot3);
                                ...
                                secc1=["Pav (Pa*sen(δ))","Pah (Pa*cos(δ))","Mwv","Mwh"]';
