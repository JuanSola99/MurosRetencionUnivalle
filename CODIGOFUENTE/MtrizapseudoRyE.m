...
%%% pseudo-esatico de un muro de retención en voladizo sección Cantilever por el metodo de RICHARD-ELMS.
...
function [FSD,FSVR,FSVA,FSDs,FSVRs,FSVAs,dEae,Ww2,Ww3]= MtrizapseudoRyE(Base1,Base2,Base3,Ha,ht,tal,D,B,alpha,phib,concreto,espesor,phi,PesoE,Cohesion,n,k,espe,pe,ph,R,TS,R1,R2,kh,kv,So)
...
%                                 append(s3,plot3);
                                ...
                                Tabla3= FormalTable(["CONDICIÓN", "(Phi)GRADOS°"],[condicion,valor]);
