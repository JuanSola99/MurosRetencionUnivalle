...
%%% pseudo-esatico de un muro de retención trapezoidal rectangular por el metodo de Simplificado.
...
function [FSD,FSVR,FSVA,FSDs,FSVRs,FSVAs,dEae]= MtripseudoSIM(Base1,Base2,Ha,D,B,alpha,phib,concreto,espesor,phi,PesoE,Cohesion,n,k,espe,pe,ph,R,TS,R1,R2,kh,kv,as,So)
...
%                                 plot3.Style = {OuterMargin("100pt", "0pt","0pt","5pt")};
                                ...
                                image41.Caption = 'Ecucaion para el angulo teta ';                                
                                add(s4,image41);
